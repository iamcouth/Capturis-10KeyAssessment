...
export class RegisterComponent implements OnInit {
  ...
  constructor(@Inject(DOCUMENT) private document, private _registerService: RegisterService,
  private _emailValid: EmailValidator, private router: Router) { }
  ...
  ngOnInit() { }
    ...
    submitRegister() {
      if (this.document.getElementById('passwordHash').value === this.document.getElementById('confirm_password').value
       && this.document.getElementById('confirm_password').value !== '') {
        if (this.captcha === '') {
